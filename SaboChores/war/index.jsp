		...
		<div class="wrapper cf">
			...
			<ul  class="widget-cols cf">
				...
				<li class="second-col">
					...
					<div class="widget-block">
						<h4>ABOUT</h4>
						<p>Sabo Chores it's completely free this means you don't have to pay anything <a href="http://luiszuno.com/blog/license" >read license</a>.</p> 
			...
			<div id="footer-bottom">Sabo Chores designed by <a href="http://www.luiszuno.com" >luiszuno.com</a></div>
