...
public class Servlet_ChoreCheck  extends HttpServlet{
        ...
        public void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
                ...
                //System.out.println("Chore: " + choreID);
                ...
                //System.out.println("Chore: " + currentChore.getChoreID());
                //System.out.println("BEFORE Chore button clicked: " + currentChore.getChoreStatus());
                                
                
                if (choreStatus.equalsIgnoreCase("Available") || choreStatus.equalsIgnoreCase("Saboed")) {
